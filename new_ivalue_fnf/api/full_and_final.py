...
# @frappe.whitelist()
# def get_full_and_final_data(doc, employee: str, relieving_date=None, ):
...
#     receivables_rows, total_receivables = receivables.build_receivables_from_employee_advances(employee, doc)
